...
| Prophecy Feature                                                                        | Single User      | Shared                                        | Not Supported isolation shared | Unity Catalog Single User                                                             | Unity Catalog Shared                                                                      |
| --------------------------------------------------------------------------------------- | ---------------- | --------------------------------------------- | ------------------------------ | ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
...
| [Execution metrics](../../execution/databricks-clusters-behaviors.md#execution-metrics) | Supported        | Not Supported                                 | Supported                      | Supported                                                                             | **Not Supported**                                                                         |
| [Run history](../../pipeline-monitoring/use-pipeline-monitoring#view-historical-runs)   | Supported        | Not Supported                                 | Supported                      | Supported                                                                             | **Not Supported**                                                                         |
