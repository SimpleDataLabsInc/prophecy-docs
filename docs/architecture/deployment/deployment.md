...
While all code generated by Prophecy lives in a User’s Git repository, we temporarily cache pieces used during Interactive development in an encrypted cache.
