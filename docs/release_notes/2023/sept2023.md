...
We are excited to introduce the [Package Hub](/docs/package-hub/package-hub.md) with Prophecy version 3.2. This feature allows platform leads to create and share standardized Pipeline components, including [custom Gems](/docs/package-hub/package-builder/gem-builder.md), Subgraphs, Datasets, Pipelines, and [more](/docs/package-hub/package-builder/package-builder.md). For instance, you can now ensure consistent data encryption in line with your company's policies. Simply create a new Project, add the required custom encryption Gems and components, and publish it as a Package. Other teams can easily add this as a dependency and utilize the components from the Package.
