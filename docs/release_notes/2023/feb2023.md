...
Pipelines running on **Unity Catalog cluster** now have the ability to show [Vanilla interims](/docs/Spark/execution/databricks-clusters-behaviours.md#vanilla-interims) on all Actions/Tail nodes of the Pipeline.
