...
:::note
For production workflows the [Phase](docs/getting-started/concepts/gems.md#phase) for the `Script` gem that updates the offsets should be greater than the Phase of the Target gem.
