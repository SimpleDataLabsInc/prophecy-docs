...
A pipeline will not execute on a schedule until its parent project is published. This is because project [publication](https://docs.prophecy.io/analysts/project-publication) determines:
