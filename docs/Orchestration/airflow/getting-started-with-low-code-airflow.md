...
Select the **(1) DBT commands** you want to run when scheduling your models. You can select all ([Dependencies](docs/extensibility/dependencies/sql-dependencies.md), [Seed](/getting-started/tutorials/sql-with-databricks), Run and Test) here.
