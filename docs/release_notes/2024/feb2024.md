...
Enhancing security, Prophecy now supports three different [Secret Providers](/docs/administration/connections-and-secrets/secret-management.md): [Databricks Secrets](/docs/administration/connections-and-secrets/databricks-secrets.md), [HashiCorp Vault](/docs/administration/connections-and-secrets/hashicorp-vault.md), and [Environment Variables](/docs/administration/connections-and-secrets/env-variable.md). Users can link these providers in the fabric they want to use and securely access secrets in their gems and pipelines. This ensures that sensitive authentication credentials are stored in their Secret Providers and used securely by Prophecy.

:::info
Prophecy never accesses the value of these secrets. It only uses the keys to generate and execute correct code.
:::

Read [here](/docs/administration/connections-and-secrets/secret-management.md) for detailed documentation.
