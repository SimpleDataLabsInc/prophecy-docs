...
[Dependencies](docs/Spark/extensibility/dependencies.md) must be installed directly on EMR clusters to use them in your projects. This includes Prophecy libraries, which you can find in our [version chart](docs/release_notes/version_chart/).
