...
Added the ability to store [Git](/docs/ci-cd/git/git.md) credentials for a user across projects. Now the user can re-use Git credentials without re-authenticating.
