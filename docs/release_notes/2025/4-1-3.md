...
- Prophecy provides the following new gems in this release.
  ...
  - [Hana Source and Target](docs/analysts/development/gems/source-target/external-table/hana.md): Using the new HANA connection, you can read and write to an SAP HANA database (Added in 4.1.3.3).
