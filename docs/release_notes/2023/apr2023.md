...
Prophecy has now made this easy with support of **[Expression Builder](/docs/Spark/gems/expression-builder.md)**.
...
Please refer [here](/docs/Spark/gems/expression-builder.md) for Detailed documentation on this feature.
