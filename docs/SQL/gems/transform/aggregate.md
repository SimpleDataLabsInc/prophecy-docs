...
:::info
To learn more about the Aggregate gem UI, see [this page](/docs/getting-started/concepts/project/gems.md) which illustrates features common to all [Gems](/SQL/gems/gems.md).
:::
