...
Click [here](docs/core/development/gems/source-target/table/upload-files.md) for further details.
...
Click [here](docs/core/development/gems/visual-expression-builder/visual-expression-builder.md) for further details.
...
Click [here](/engineers/data-generator) for further details.

### Bulk actions Gems for cleaning messy data

<div class="wistia_responsive_padding" style={{padding:'56.25% 0 0 0', position:'relative'}}>
<div class="wistia_responsive_wrapper" style={{height:'100%',left:0,position:'absolute',top:0,width:'100%'}}>
<iframe src="https://fast.wistia.net/embed/iframe/ajqzc7wz7c?seo=false?videoFoam=true" title="CleanupMessyData" allow="autoplay; fullscreen" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed" msallowfullscreen width="100%" height="100%"></iframe>
</div></div>

### Data Delivery and Access Simplified

<div class="wistia_responsive_padding" style={{padding:'56.25% 0 0 0', position:'relative'}}>
<div class="wistia_responsive_wrapper" style={{height:'100%',left:0,position:'absolute',top:0,width:'100%'}}>
<iframe src="https://fast.wistia.net/embed/iframe/3cwy1mxgd7?seo=false?videoFoam=true" title="DataDelivery" allow="autoplay; fullscreen" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed" msallowfullscreen width="100%" height="100%"></iframe>
</div></div>
...
To learn more, see [SQL Gem Builder](/analysts/gem-builder).
