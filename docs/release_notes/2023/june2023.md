...
The [Data Explorer](docs/analysts/development/data-explorer.md) feature empowers users to explore and analyze their data samples directly within the user interface (UI).
