...
With this feature, users can gain insights, verify data accuracy, and make informed decisions by leveraging the filter/sort/download capabilities directly in UI. Please refer [here](/docs/SQL/development/interactive-development/data-explorer.md) for detailed documentation.
