...
| `customOutputSchemaEnabled` | Enables the [custom schema](docs/getting-started/concepts/gems.md#output-ports) option by default in the gem. Requires gemLibsVersion 1.1.47+ for Scala. | Boolean                                | Transformation              |
