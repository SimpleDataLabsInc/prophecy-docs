...
Project tests perform a SQL query that checks the executed result of your project against a passing condition to see if it is successful. This is done by checking whether a particular table, generated by combining one or more database objects from your transformation, meets a certain condition.
...
2. Create your Job Model by dragging and dropping a Gem to your Visual canvas.
