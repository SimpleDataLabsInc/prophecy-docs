...
Please read more about this feature [here](/docs/enterprise/fabrics/Spark-fabrics/databricks/databricks.md).
...
We have added Warnings and Diagnostics if Users are using plain text Passwords in gems. Read about the recommended usage [here](docs/enterprise/fabrics/secrets/secrets.md).
