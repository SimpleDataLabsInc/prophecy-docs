...
* Provide credentials to Github
  * creating a fine-grained Personal Acces Token (PAT) in Github. The PAT should be scoped to yourself or your Organization, have access to the repository containing the Prophecy project, and appropriate permissions: ![github-pat-permissions.png](img/github-pat-permissions.png)
...
<img src="img/hello-cicd-declarative-test_configure.png" alt="hello-cicd-declarative-test_configure.png" data-size="original">
...
<img src="img/hello-cicd-declarative-test_configure-trigger.png" alt="hello-cicd-declarative-test_configure-trigger.png" data-size="original">
...
<img src="img/hello-cicd-declarative-deploy_configure.png" alt="hello-cicd-declarative-deploy_configure.png" data-size="original">
