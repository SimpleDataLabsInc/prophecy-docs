...
- **Gem Builder for Airflow** : To further enhance customization and extensibility, we have added support for Airflow Gems in [Gem Builder](/docs/Spark/extensibility/gem-builder.md). This feature empowers you to add any operators you desire, allowing for greater versatility and tailored workflows with Airflow.
...
With this feature, users can gain insights, verify data accuracy, and make informed decisions by leveraging the filter/sort/download capabilities directly in UI. Please refer [here](/docs/SQL/development/visual-editor/interactive-development/data-explorer.md) for detailed documentation.
