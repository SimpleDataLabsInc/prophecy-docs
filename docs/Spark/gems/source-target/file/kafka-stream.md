...
:::note
For production workflows the [Phase](docs/get-started/concepts/project/gems.md#phase) for the `Script` gem that updates the offsets should be greater than the Phase of the Target gem.
