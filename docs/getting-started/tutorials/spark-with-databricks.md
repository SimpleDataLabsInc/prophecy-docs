...
You should see the [project metadata](/getting-started/concepts/metadata) page. Project metadata includes information about the contents, dependencies, settings, and more related to your project. We want to start editing the project, so click **Open in Editor**.
