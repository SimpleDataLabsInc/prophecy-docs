...
An administrator will have the option to create the following tables at the time of team creation which are used for storing [Execution Metrics](/engineers/execution-metrics). The administrator will grant access to the tables accordingly to their team members.
