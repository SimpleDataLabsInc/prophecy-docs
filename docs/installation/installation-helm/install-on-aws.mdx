...
In this guide, we'll walk you through one way to install Prophecy on an [EKS cluster](https://aws.amazon.com/eks/) in AWS. Note that this is just one way to perform the installation.

If you are already an expert with Kubernetes, Athena, and Helm charts, you can simply view the [requirements](../installation-helm) and install Prophecy your own way.
