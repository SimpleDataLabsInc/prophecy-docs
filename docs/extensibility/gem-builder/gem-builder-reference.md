...
| `customOutputSchemaEnabled` | Enables the [custom schema](docs/getting-started/concepts/project/gems.md#outputs) option by default in the gem. Requires gemLibsVersion 1.1.47+ for Scala. | Boolean                                | Transformation              |
