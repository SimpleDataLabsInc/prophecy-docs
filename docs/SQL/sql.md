...
To get started developing SQL models, check out the pages below or try this guide for [Databricks](/docs/tutorials/end-to-end/getting-started-with-low-code-sql.md) or [Snowflake](/docs/tutorials/end-to-end/getting-started-sql-snowflake.md).
