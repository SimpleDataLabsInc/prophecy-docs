...
1. Set up your [S3 connection](/core/prophecy-fabrics/connections/s3).
...
| Select or create connection                          | Select an existing S3 connection or [create a new one](/core/prophecy-fabrics/connections/s3).                                                                                                                                    |
