...
:::note
For production workflows the [phase](docs/getting-started/concepts/gems.md#gem-phase) for the `Script` gem that updates the offsets should be greater than the Phase of the Target gem.
