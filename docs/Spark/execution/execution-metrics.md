...
| Flag                        | Execution Metrics Enabled                                                                                                                                                                                                                              | Execution Metrics Disabled                                                                                                                                                                                                  |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Execution metrics flag      | <ul><li>All available pipeline and component data stored</li><li>Historical run data accessible in UI</li><li>Metrics tables populated with performance data</li></ul>                                                                                 | <ul><li>No execution data stored to metrics tables</li><li>Interactive runs show temporary data based on other enabled flags</li><li>Historical run data unavailable</li></ul>                                              |
| Pipeline data sampling flag | <ul><li>Data stored based on execution metrics flag setting</li><li>Interactive run interims visible in UI</li><li>Interim data stored if execution metrics enabled</li><li>Real-time data preview available during pipeline development</li></ul>     | <ul><li>Pipeline metrics still stored based on execution metrics flag</li><li>Interactive run interims neither visible in UI nor stored</li><li>No real-time data sampling during development</li></ul>                     |
| Job data sampling flag      | <ul><li>Component-level data stored based on execution metrics flag</li><li>Job run interims generated and displayed</li><li>Scheduled job interim data available for analysis</li><li>Historical job performance tracking enabled</li></ul>           | <ul><li>Basic job metrics stored based on execution metrics flag</li><li>Job run interims not visible in historical UI</li><li>No interim data storage for scheduled jobs</li><li>Limited job-level data insights</li></ul> |
| Pipeline monitoring flag    | <ul><li>Individual component (Gem) metrics collected</li><li>Detailed component-level data visible in UI</li><li>Component performance data stored based on execution metrics flag</li><li>Granular pipeline debugging information available</li></ul> | <ul><li>High-level pipeline metrics still stored</li><li>Individual component data neither visible nor stored</li><li>Limited debugging capabilities</li><li>No component-level performance insights</li></ul>              |
