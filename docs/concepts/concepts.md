...
Learn more [here](/docs/SQL/index.md) about Prophecy Copilot for SQL and get started with [this guide](/docs/getting-started/getting-started-with-low-code-sql.md).
