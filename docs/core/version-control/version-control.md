...
:::note
The way you use Git will also influence how you collaborate in Prophecy. To learn more, visit [Real-time collaboration](docs/core/development/collaboration/collaboration-modes.md).
:::
