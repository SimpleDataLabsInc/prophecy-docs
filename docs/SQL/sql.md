...
To get started developing SQL models, check out the pages below or try this guide for [Databricks](/docs/get-started/tutorials/getting-started-with-low-code-sql.md) or [Snowflake](/docs/get-started/tutorials/getting-started-sql-snowflake.md).
