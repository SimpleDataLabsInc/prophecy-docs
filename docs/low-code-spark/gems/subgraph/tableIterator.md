...
In the table above, map the columns from the incoming DataFrame, to the configs of the Subgraph.
...
You can add more input and Output ports as per the use case.
