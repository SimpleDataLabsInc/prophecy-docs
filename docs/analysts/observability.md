...
Projects that have been [published](/analysts/development/version-control/) to Prophecy fabrics will appear in the **Deployed Projects** tab of the page. Each row represents a different project deployment and displays the following information.
