...
Enhancing security, Prophecy now supports three different [Secret Providers](docs/enterprise/fabrics/secrets/secret-providers.md): Databricks Secrets, HashiCorp Vault, and Environment Variables. Users can link these providers in the fabric they want to use and securely access secrets in their gems and pipelines. This ensures that sensitive authentication credentials are stored in their Secret Providers and used securely by Prophecy.
