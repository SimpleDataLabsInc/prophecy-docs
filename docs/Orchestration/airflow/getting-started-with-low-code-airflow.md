...
Select the **(1) DBT commands** you want to run when scheduling your Models. You can select all ([Dependencies](/extensibility/dependencies), [Seed](/getting-started/sql-with-databricks#431-create-seeds), Run and Test) here.
