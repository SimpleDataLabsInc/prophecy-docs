...
| Fabric            | The [execution fabric](/getting-started/concepts/fabrics) to which the job is going to be deployed.                                                                                                                                           |
| Job Size          | The [default size](/getting-started/concepts/fabrics#whats-in-a-fabric) of the cluster that's going to be created for the job to run.                                                                                                         |
...
| Scheduler                 | The underlying engine that's going to execute your job. Databricks is recommended.                                                                                                                                                            |
| Fabric                    | The [execution fabric](/getting-started/concepts/fabrics) to which the job is going to be deployed.                                                                                                                                           |
| Cluster Size              | The [default size](/getting-started/concepts/fabrics#whats-in-a-fabric) of the cluster that's going to be created for the job to run.                                                                                                         |
