...
Select the **(1) DBT commands** you want to run when scheduling your Models. You can select all ([Dependencies](docs/extensibility/dependencies/sql-dependencies.md), [Seed](docs/tutorials/end-to-end/getting-started-with-low-code-sql.md#431-create-seeds), Run and Test) here.
