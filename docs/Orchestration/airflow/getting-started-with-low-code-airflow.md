...
If you don't have an existing project, please check out [this guide](https://docs.prophecy.io/concepts/project/#1-create-new-project) for setting up a Spark project, and [this guide](docs/getting-started/tutorials/sql-with-databricks.md) for setting up a SQL model in Prophecy.
...
Select the **(1) DBT commands** you want to run when scheduling your models. You can select all ([Dependencies](docs/extensibility/dependencies/sql-dependencies.md), [Seed](/getting-started/tutorials/sql-with-databricks#431-create-seeds), Run and Test) here.
