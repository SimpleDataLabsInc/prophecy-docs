...
Once you have developed a [Spark pipeline](/docs/getting-started/concepts/project/pipelines.md) using Prophecy, you will want to schedule it to run at
...
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Project           | Which [Project](/docs/getting-started/concepts/project/project.md) to create the job in. This controls who has access to the job, groups jobs together for lineage, and allows you to use pipelines already published within that project.    |
...
| Fabric            | The [execution fabric](docs/getting-started//concepts/fabrics/fabrics.md) to which the job is going to be deployed.                                                                                                                           |
| Job Size          | The [default size](docs/getting-started//concepts/fabrics/fabrics.md) of the cluster that's going to be created for the job to run.                                                                                                           |
...
| Scheduler                 | The underlying engine that's going to execute your job. Databricks is recommended.                                                                                                                                                            |
| Fabric                    | The [execution fabric](docs/getting-started/concepts/fabrics/fabrics.md) to which the job is going to be deployed.                                                                                                                            |
| Cluster Size              | The [default size](docs/getting-started/concepts/fabrics/fabrics.md) of the cluster that's going to be created for the job to run.                                                                                                            |
