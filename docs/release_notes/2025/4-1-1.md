...
- We've added the ability to [reindex your SQL warehouse](/administration/fabrics/prophecy-fabrics/knowledge-graph-config) for the knowledge graph. This ensures that Prophecy's AI agent has the latest information about your datasets (Added in 4.1.1.2).
