...
Previously when writing a SQL model using an [SCD2 merge approach](/SQL/gems/target-models/write-options), you could only define one unique key. This update lets you define one or more unique keys.
