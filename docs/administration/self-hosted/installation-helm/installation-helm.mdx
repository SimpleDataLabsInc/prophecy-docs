...
For an example step-by-step installation, visit [AWS installation guide](https://docs.prophecy.io/administration/self-hosted/installation-helm/install-on-aws).
