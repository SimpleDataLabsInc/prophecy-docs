...
| Column name of a corrupt record            | Allows you to rename the field the PERMISSIVE mode creates to store malformed data. <br/>This overrides `spark.sql.`<br/>`columnNameOfCorruptRecord`.                                                                                        | `_corrupt_records`                 |
