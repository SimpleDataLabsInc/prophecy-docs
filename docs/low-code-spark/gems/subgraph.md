...
Like [Pipeline Configurations](../configuration.md), In Subgraph Configs, User can define values which can be set at Subgraph level and then be accessed inside any component in the Subgraph.
