...
- **Config syntax**: We've unified the config syntax across all project types by supporting Jinja config syntax. This means that you can use `{{foo}}` for variable substitution.
