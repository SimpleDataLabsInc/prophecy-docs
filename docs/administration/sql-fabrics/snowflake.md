...
SQL models can be scheduled using Airflow to run on Snowflake. Create an [Airflow fabric](docs/administration/airflow-fabrics/airflow-fabrics.md), and set up a Snowflake Connection that references the Snowflake fabric created above. Prophecy supports Snowflake Connections from these three Airflow flavors: [Composer](docs/administration/airflow-fabrics/composer.md), [MWAA](docs/administration/airflow-fabrics/mwaa.md), and [Prophecy Managed Airflow](docs/administration/airflow-fabrics/prophecy-managed.md).
