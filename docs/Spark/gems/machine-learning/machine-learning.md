...
- Option a. Import a project with the spark-ai dependency preconfigured, as in this [guide.](docs/tutorials/end-to-end/genaichatbot.md#1c-load-the-git-repository)
